...
export default function About() {
    ...
    return (<div id="about" className="flex flex-col justify-center items-center w-11/12 md:w-3/4 mx-auto ">
        ...
        <div className="flex flex-col md:flex-row w-full gap-4">
            {/* About Me Izq */}
            <div className="relative h-[520px] w-full md:h-162.5 md:w-1/3 bg-white/10 backdrop-blur-xl border border-white/10 shadow-lg rounded-2xl text-white flex flex-col items-end">
